...
return (
    <div className="doctors_list_container">
      <div className="doctors_list_header">
        <h1 className="doctors_list_page-title">Our Prenatal Care Specialists</h1>
        ...
        {doctors.map((doctor) => (
          <div key={doctor._id} className="doctors_list_doctor-card">
            <div className="doctors_list_doctor-image-container">
              <img
                src={doctor.image_url || "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?q=80&w=500"}
                alt={doctor.name}
            ...
            <div className="doctors_list_doctor-info">
              ...
              <p className="doctors_list_doctor-specialization">{doctor.specialization}</p>
              <p className="doctors_list_doctor-hours">
                Working hours: {doctor.working_hours.start} - {doctor.working_hours.end}
              </p>
              <Link to={`/book/${doctor._id}`} className="doctors_list_book-button">
                Book Appointment
              </Link>
            </div>
          </div>
